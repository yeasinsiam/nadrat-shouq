...
const TermsAndConditions = () => {
  return (
    <>
      <Head>
        <title>Terms & Conditions - Nadrat Shouq Est</title>
      </Head>
      <section className="cs-container mt-5 pb-5 ">
        <div className="prose prose-sm prose-zinc p-5 rounded-lg border shadow-lg max-w-full block">
          <h1>Terms and Conditions</h1>
          <p style={{ marginBottom: 0 }}>Last updated: November 05, 2023</p>
          <p style={{ marginTop: 0 }}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Nadrat Shouq Est, Al- badr, Al-
                shifa industrial, Riyadh 14727, Saudi Arabia..
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Nadrat Shouq Est, accessible
                from{" "}
                <a
                  href="http://nadrat-ounak.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  http://nadrat-ounak.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <p>
            ...
            reasonable efforts to provide at least 30 {`day's`} notice prior to
          ...
          <ul>
            <li>
              ...
              <a
                href="http://nadrat-ounak.com/contact-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://nadrat-ounak.com/contact-us
              </a>
            </li>
          </ul>
        </div>
